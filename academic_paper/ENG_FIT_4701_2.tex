...
through expert consultation within study partners as well as a Monash University researcher with
expertise in survey design and human data collection, which informed
wording improvements and helped keep the assessment concise. These
...
\begin{table}[t]
\caption{Composite Likert scores (mean $\pm$ SD) with paired $t$-test results ($n = 40$, $df = 40$). Effect size $d_z = t/\sqrt{n}$.}
\label{tab:quant}
\centering
