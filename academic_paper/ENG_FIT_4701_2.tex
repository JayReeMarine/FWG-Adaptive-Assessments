...
\begin{figure}[t]
  ...
  \caption{This project is structured into eight distinct phases spanning two semesters. The initial three stages establish the foundational framework and strategic direction of the research, while the remaining phases focus on ethical clearance, data collection, and in-depth analysis.}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.82\columnwidth]{figures/demographic_relevance.png}
  \label{fig:demographic_relevance}
\end{figure}
...
\begin{figure*}[t]
  ...
  \caption{Composite Relevance scores by demographic subgroup ($n=40$). The LLM-based method (blue) was rated higher than the rule-based method (purple) in every subgroup. The 26--34 age group and working professionals showed the largest gaps; Clarity and Quality exhibited similar but smaller directional patterns across all subgroups (not shown).}
