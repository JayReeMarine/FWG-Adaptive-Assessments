...
endorsement rather than mutually exclusive preference. When participants
who endorsed both methods ($n=22$) and those who selected neither ($n=2$)
are combined, 24 participants (60.0\%) expressed no strong preference for
one method over the other. Among those who did indicate a directional
preference, the LLM-based method was endorsed by 17 participants
(42.5\%), compared with eight (20.0\%) for the rule-based method.

These results show broad acceptance of both approaches, but stronger
endorsement for the LLM-based version among participants who
differentiated between methods. The large no-strong-preference group
indicates that the rule-based method was not perceived as poor; rather,
the LLM-based method appeared to add personalisation and awareness of
