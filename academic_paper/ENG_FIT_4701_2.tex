...
user states. This study presents Navigator, a web-based prototype for mental health comparing
a static rule-based monthly check-in with a dynamic LLM-based method. Based on the baseline questions using a controlled persona and previous-month
health profile, we generate subsequent monthly questions and compared static Rule-based and dynamic LLM-based methods. Forty valid participants evaluated both methods through a
within-subjects survey grounded in COSMIN content-validity dimensions:
Clarity, Relevance, and Quality. The dynamic LLM-based method received higher
